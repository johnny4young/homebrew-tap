...
| `portavoz` | `0.1.0` | Privacy-first meeting assistant — knows who said what, locally | <https://portavoz.app> |
...
| --- | --- | --- | --- |
| `gos` | `1.6.0` | Go Switch - install and switch Go versions in seconds | <https://github.com/johnny4young/gos> |
<!-- END:formulae -->
