...
| `portavoz` | `1.0.0` | Privacy-first meeting assistant — knows who said what, locally | <https://portavoz.app> |
| `vitrine` | `1.2.2` | Menu-bar app for polished terminal and code captures | <https://vitrineframe.app/> |
<!-- END:casks -->
